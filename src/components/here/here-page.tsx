...
const steps = [
  {
    ...
    text: "Имя, телефон, город. Займёт пару минут — как анкета на подключение, без похода в МФЦ.",
  },
  {
...
const faq = [
  ...
  },
  {
    ...
    a: "Да. Переход со своим номером — основной сценарий этой страницы. Срок переноса скажут в салоне.",
  },
  {
    q: "Что входит в «Минимум +»?",
    a: "Базовый тариф витрины: от 850 ₽ за 30 дней (Москва, с НДС), 400 минут по России, интернет в пакете на карты, такси и мессенджеры, безлимит на МегаФон России когда минуты закончились. Автоматически +10 ГБ, если платите вовремя. «Тёплый приём» для нерезидентов подключается сам. 100 международных минут можно докупить.",
  },
  {
    q: "Что входит в «Семейный +»?",
    a: "Максимальный тариф витрины: от 1 140 ₽ за 30 дней, 1 500 минут по России, безлимитный интернет, МегаСемья до 5 человек. Хватает на Яндекс Go, навигацию, склады, видеосервисы, ТВ, соцсети и национальные сайты страны, откуда вы приехали. Общение с близкими в доступных в РФ мессенджерах.",
  },
  {
      ...
      <main>
          ...
          <div className="mx-auto grid max-w-6xl items-start gap-10 px-4 py-12 sm:px-6 lg:grid-cols-[1.15fr_0.85fr] lg:py-16">
            <div>
              ...
              <p className="mt-5 max-w-xl text-lg leading-relaxed text-white/75">
                Как на лендинге подработки: заявка сразу, оффер понятный, без
                седьмого клика. Биометрию заново сдавать не надо. Тарифы и
                спецпродукты — из ТЗ «Единая платформа».
              </p>
            ...
            >
              ...
              <p className="mt-3 text-xs text-muted-foreground">
                Демоформа: консультант в этой среде не звонит.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="formats" className="bg-[#f6f7f2] py-16">
          <div className="mx-auto max-w-6xl px-4 sm:px-6">
            ...
            <p className="mt-3 max-w-2xl text-muted-foreground">
              Как «на авто / велосипеде / пешком» на Еде: два публичных тарифа
              витрины. Базовый — «Минимум +». Максимальный — «Семейный +».
            </p>
            ...
            <div className="mt-8 overflow-hidden rounded-[1.75rem] bg-white p-6 sm:p-8">
              ...
              <p className="mt-2 text-muted-foreground">
                Интернет: {extraGb}. Спецпродукты ниже считаются отдельно — как
                чаевые и бонусы на Еде.
              </p>
        ...
        <section id="perks" className="bg-white py-16">
          <div className="mx-auto max-w-6xl px-4 sm:px-6">
            ...
            <p className="mt-3 max-w-2xl text-muted-foreground">
              Все спецпродукты из ТЗ. Где написано «сам» — подключается
              автоматически, без охоты за акцией.
            </p>
        ...
        <section id="how" className="bg-[#111] py-16 text-white">
          <div className="mx-auto max-w-6xl px-4 sm:px-6">
            ...
            <p className="mt-3 max-w-2xl text-white/65">
              Короче, чем первая SIM. Не путайте со страницей «только приехал».
            </p>
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Свой номер, готовая биометрия, тариф из ТЗ.
            </DialogDescription>
          </DialogHeader>
          <CallbackForm
            key={tariffId}
