...
export const dictionaries: Record<Locale, Dict> = {
  ru: {
    ...
    formSubmit: "Оставить номер",
    formSending: "Отправляем…",
    formSuccessTitle: "Номер принят",
    formSuccessText:
      "Перезвоним в рабочие часы. Подскажем салон и какие бумаги взять.",
  ...
  uz: {
    ...
    formComment: "Izoh",
    formSubmit: "Raqam qoldirish",
    formSending: "Yuborilmoqda…",
    formSuccessTitle: "Raqam qabul qilindi",
    formSuccessText:
  ...
  tg: {
    ...
    formComment: "Шарҳ",
    formSubmit: "Рақам гузоред",
    formSending: "Фиристода истодааст…",
    formSuccessTitle: "Рақам қабул шуд",
    formSuccessText:
  ...
  ky: {
    ...
    formComment: "Комментарий",
    formSubmit: "Номер калтыруу",
    formSending: "Жөнөтүлүүдө…",
    formSuccessTitle: "Номер кабыл алынды",
    formSuccessText:
